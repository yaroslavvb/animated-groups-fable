...
const view = createView({tilePixels: number('scale', minScale, MAX_SCALE) ?? scaleFor, center: [number('x', -1e9, 1e9) ?? CENTER[0], number('y', -1e9, 1e9) ?? CENTER[1]], angle: (number('angle', -1e6, 1e6) ?? 0) * Math.PI / 180, minScale});
